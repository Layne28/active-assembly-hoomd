...
kTs=(0.000000)
vas=(0.100000 0.300000 0.500000 2.000000)
...
for va in "${vas[@]}"; do
    ...
    srun parallel -k --lb --jobs $njob "python $run_dir/structure_factor.py $SCRATCH/active-assembly-hoomd/manyseed/${potential}/${d}d/kT={1}/phi={2}/${va}/{3}/lambda={4}/Lx=${Lx}_Ly=${Lx}/nx=${nx}_ny=${nx}/interpolation=${interp}/${compressibility}/${cov_type}/seed={5}/prod/traj.gsd 5 > $SCRATCH/active-assembly-hoomd/log/sq_kT={1}_phi={2}_va=${va}_{3}_lambda={4}_seed={5}.out" \
                            ::: ${kTs[@]} \
                            ::: ${phis[@]} \
                            ::: ${taus[@]} \
                            ::: ${lambdas[@]} \
    ...
    srun parallel -k --lb --jobs $njob "python $run_dir/cluster.py $SCRATCH/active-assembly-hoomd/manyseed/${potential}/${d}d/kT={1}/phi={2}/va=${va}/{3}/lambda={4}/Lx=${Lx}_Ly=${Lx}/nx=${nx}_ny=${nx}/interpolation=${interp}/${compressibility}/${cov_type}/seed={5}/prod/traj.gsd > $SCRATCH/active-assembly-hoomd/log/cluster_kT={1}_phi={2}_va=${va}_{3}_lambda={4}_seed={5}.out" \
                            ::: ${kTs[@]} \
                            ::: ${phis[@]} \
                            ::: ${taus[@]} \
                            ::: ${lambdas[@]} \
    ...
    srun parallel -k --lb --jobs $njob "python $run_dir/trajectory_stats.py $SCRATCH/active-assembly-hoomd/manyseed/${potential}/${d}d/kT={1}/phi={2}/va=${va}/{3}/lambda={4}/Lx=${Lx}_Ly=${Lx}/nx=${nx}_ny=${nx}/interpolation=${interp}/${compressibility}/${cov_type}/ sq_var average postprocessed > $SCRATCH/active-assembly-hoomd/log/sq_var_kT={1}_phi={2}_va=${va}_{3}_lambda={4}_avg.out" \
                            ::: ${kTs[@]} \
                            ::: ${phis[@]} \
                            ::: ${taus[@]} \
                            ::: ${lambdas[@]}  | tr -d \''"\' &
    ...
    srun parallel -k --lb --jobs $njob "python $run_dir/trajectory_stats.py $SCRATCH/active-assembly-hoomd/manyseed/${potential}/${d}d/kT={1}/phi={2}/va=${va}/{3}/lambda={4}/Lx=${Lx}_Ly=${Lx}/nx=${nx}_ny=${nx}/interpolation=${interp}/${compressibility}/${cov_type}/ sq_traj average postprocessed > $SCRATCH/active-assembly-hoomd/log/sq_traj_kT={1}_phi={2}_va=${va}_{3}_lambda={4}_avg.out" \
                            ::: ${kTs[@]} \
                            ::: ${phis[@]} \
                            ::: ${taus[@]} \
                            ::: ${lambdas[@]}  | tr -d \''"\' &
    ...
    srun parallel -k --lb --jobs $njob "python $run_dir/trajectory_stats.py $SCRATCH/active-assembly-hoomd/manyseed/${potential}/${d}d/kT={1}/phi={2}/va=${va}/{3}/lambda={4}/Lx=${Lx}_Ly=${Lx}/nx=${nx}_ny=${nx}/interpolation=${interp}/${compressibility}/${cov_type}/ csd average postprocessed > $SCRATCH/active-assembly-hoomd/log/csd_kT={1}_phi={2}_va=${va}_{3}_lambda={4}_avg.out" \
                            ::: ${kTs[@]} \
                            ::: ${phis[@]} \
                            ::: ${taus[@]} \
                            ::: ${lambdas[@]}  | tr -d \''"\' &
